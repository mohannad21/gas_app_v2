...
revision = "0021_new_ledger_schema"
down_revision = "0020_remove_bilateral_order_fields"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
  raise NotImplementedError("Downgrade not supported for new ledger schema.")
